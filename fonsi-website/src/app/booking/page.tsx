          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
            <ScrollReveal delay={0}>
              <div>
                ...
                <p className="text-neutral-700 font-sans text-sm">Tuesday &ndash; Saturday</p>
                <p className="text-neutral-900 font-sans text-sm">10:00 AM &ndash; 6:30 PM</p>
                <p className="text-neutral-400 font-sans text-xs mt-2">Sunday & Monday: Closed</p>
              </div>
            </ScrollReveal>
