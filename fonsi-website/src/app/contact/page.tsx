      ...
      <section className="section-padding">
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <a
                    href="tel:2105517742"
                    className="text-gray-300 font-sans text-lg hover:text-gold-500 transition"
                  >
                    (210) 551-7742
                  </a>
            ...
            {/* Map Placeholder */}
            <div className="relative h-96 lg:h-auto rounded-lg overflow-hidden border border-gold-500/30">
      ...
      <section className="section-padding bg-dark-800">
        <div className="container-custom">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            <details className="bg-dark-700 border border-gold-500/30 rounded-lg p-6 open:border-gold-500/60 transition group">
              <summary className="cursor-pointer font-serif font-bold text-gold-500 text-lg group-open:text-gold-400 flex items-center justify-between transition">
                Do you accept walk-ins?
                <span className="transition group-open:rotate-180">►</span>
              </summary>
              <p className="text-gray-300 font-sans mt-4">
                No, Fonsi operates by appointment only. This ensures you receive personalized
                attention and avoid wait times. Please call (210) 551-7742 to schedule your
                appointment.
              </p>
            </details>
            ...
            <details className="bg-dark-700 border border-gold-500/30 rounded-lg p-6 open:border-gold-500/60 transition group">
              ...
              <p className="text-gray-300 font-sans mt-4">
                We require 24-hour notice for cancellations. If you need to cancel within 24 hours
                of your appointment, a 50% service charge will apply to your account.
              </p>
            </details>
            ...
            <details className="bg-dark-700 border border-gold-500/30 rounded-lg p-6 open:border-gold-500/60 transition group">
              ...
              <p className="text-gray-300 font-sans mt-4">
                Prices vary based on hair length, density, complexity, and specific services. The
                prices listed on our site are estimates. Final pricing will be discussed during
                your consultation or when booking.
              </p>
            </details>
            ...
            <details className="bg-dark-700 border border-gold-500/30 rounded-lg p-6 open:border-gold-500/60 transition group">
              ...
              <p className="text-gray-300 font-sans mt-4">
                Yes! We offer comprehensive bridal packages including bride hair and makeup,
                wedding party styling, and on-site services. Bridal services are available by
                consultation. Please contact us to discuss your wedding day needs.
              </p>
            </details>
            ...
            <details className="bg-dark-700 border border-gold-500/30 rounded-lg p-6 open:border-gold-500/60 transition group">
              ...
              <p className="text-gray-300 font-sans mt-4">
                We accept all major credit cards and cash. Payment is typically due at the time
                of service. Please contact us for details about payment options.
              </p>
            </details>
          </div>
        </div>
      ...
      <section className="section-padding">
        <div className="container-custom text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="/booking"
              className="bg-gold-500 text-dark-900 px-8 py-4 rounded-lg font-sans font-semibold hover:bg-gold-400 transition"
            >
              Book Online
            </a>
            <a
              href="tel:2105517742"
              className="border-2 border-gold-500 text-gold-500 px-8 py-4 rounded-lg font-sans font-semibold hover:bg-gold-500/10 transition"
            >
              Call (210) 551-7742
            </a>
          </div>
