...
export default function Footer() {
  ...
  return (
    <footer className="bg-dark-900 border-t border-gold-500 border-opacity-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/" className="text-gray-400 hover:text-gold-500 text-sm transition">
                  Home
                </Link>
              </li>
              <li>
                <Link href="/services" className="text-gray-400 hover:text-gold-500 text-sm transition">
                  Services
                </Link>
              </li>
              <li>
                <Link href="/gallery" className="text-gray-400 hover:text-gold-500 text-sm transition">
                  Gallery
                </Link>
              </li>
              <li>
                <Link href="/about" className="text-gray-400 hover:text-gold-500 text-sm transition">
                  About
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                ...
                <a href="tel:2105517742" className="text-gray-400 hover:text-gold-500 text-sm transition">
                  (210) 551-7742
                </a>
              </li>
              <li className="flex items-start gap-2">
        ...
        {/* Bottom Bar */}
        <div className="border-t border-gold-500 border-opacity-20 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-500 text-sm">
              &copy; {currentYear} Fonsi by Cristal. All rights reserved.
            </p>
            <p className="text-gray-500 text-xs">
              24-hour cancellation policy applies • 50% charge within 24 hours
            </p>
          </div>
        </div>
      </div>
